...
function fetchUserData(id: UserID): { id: number; name: string } {
...
function getWidth(rectangle: { base: number; height: number }): number {
...
// const data: Promise<ApiData> = fetchData("/api/user");
